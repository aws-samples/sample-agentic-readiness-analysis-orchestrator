...
```bash
atx custom def exec -n <portfolio_bao_td> -p . -g file://atx-config-portfolio-bao.yaml -x -t
```

### Bridge

```bash
atx custom def exec -n <portfolio_bridge_td> -p . -g file://atx-config-bridge.yaml -x -t
```
...
|---|---|---|
| Per-repo ARA / MOD / BAO | 1200000 | 20 minutes |
| Portfolio ARA / MOD / BAO / Bridge | 1800000 | 30 minutes |
