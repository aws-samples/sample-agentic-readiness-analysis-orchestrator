...
Constraint extraction approach based on BPMN2Constraints (Bergman, Rebmann, Kampik -- SAP Signavio, BPM 2023).
...
1. **Do not change the JSON output schema** without updating the BPMN Opportunity Transformation Definition (`../../definitions/custom/bpmn-opportunity-analysis/SKILL.md`) which consumes it
