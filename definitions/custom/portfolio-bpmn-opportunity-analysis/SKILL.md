---
name: portfolio-bpmn-opportunity-analysis
description: Aggregate per-repo BAO reports into a portfolio-level view of cross-repo agent opportunity patterns, Bedrock consumption forecast, and consolidated implementation roadmap
version: 0.1.0
---
