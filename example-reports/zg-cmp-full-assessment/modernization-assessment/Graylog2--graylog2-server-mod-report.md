...
| **Recommendation** | Enable Amazon ECR image scanning for container vulnerability detection. Use AWS Inspector for runtime vulnerability assessment on EKS nodes. The existing Dependabot setup is a strong foundation — complement it with infrastructure-level scanning. |
