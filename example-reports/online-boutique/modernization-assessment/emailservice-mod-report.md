...
| **Gap** | No vulnerability scanning for container images or runtime. No SSM Patch Manager equivalent. Hardening is excellent, but there's no continuous vulnerability assessment. |
