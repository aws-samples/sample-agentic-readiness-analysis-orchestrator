...
- **Remediation Timeline**: 30–60 days
- **Recommendation**: Conduct a data residency assessment. Document whether cart data is subject to any residency or sovereignty requirements. If so, configure the agent's LLM endpoint to respect those boundaries.
...
- **Recommendation**: Conduct data residency assessment. Configure agent LLM endpoint in same region as data.
- **Evidence**: `terraform/variables.tf`, `terraform/memorystore.tf`
