...
- **Gap**: No formal data residency documentation for PCI/PII data. No assessment of whether agent-initiated requests could transmit PCI/PII data to LLM providers in different jurisdictions.
- **Compensating Controls**:
