...
| **Recommendation** | If container images are created for gulp, use hardened base images (e.g., AWS Bottlerocket, `node:22-slim`) and enable ECR image scanning. Integrate AWS Inspector for vulnerability assessment. |
