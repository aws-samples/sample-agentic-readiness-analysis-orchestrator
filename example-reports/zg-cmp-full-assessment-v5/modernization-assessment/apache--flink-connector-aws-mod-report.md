...
| **Gap** | Java 11 is the minimum target rather than Java 17+. While the CI tests on 17 and 21, the project targets Java 11 as the baseline. Java 11 LTS extended support ends September 2026. The framework is not Spring Boot (using Flink runtime), so framework-lag assessment is N/A — Flink 2.0.0 is the current major version. |
