...
- **Gap**: No machine identity authentication — expected for a browser-only frontend. The backend API is the correct analysis target for this question.
