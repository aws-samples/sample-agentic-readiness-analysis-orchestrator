...
| Optimization and Licensing Assessment | OLA | Oracle and SQL Server JDBC drivers detected in camunda-invoice | camunda-invoice has Oracle (v23.5.0.24.07) and SQL Server (v8.4.1) JDBC drivers; CI matrix tests against Oracle 19/23 and SQL Server 2017/2019/2022 | Request OLA engagement to assess commercial database licensing optimization |
