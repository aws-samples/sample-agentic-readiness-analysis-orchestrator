...
- **Gap**: No formal data residency documentation. No analysis of whether EU maintainer email addresses in `tools-tested-by-miwg.json` require GDPR-compliant handling when sent to an LLM provider.
- **Compensating Controls**:
...
- **Gap**: No formal data residency documentation. No GDPR analysis for EU maintainer PII.
