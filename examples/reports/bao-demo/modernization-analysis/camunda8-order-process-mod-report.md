...
| **Gap** | Secrets hardcoded in code or committed to version control. This is the most critical finding in the entire analysis. Anyone with access to this repository can use these credentials to connect to the Camunda 8 cluster, deploy arbitrary BPMN processes, start process instances, and complete/fail active jobs. |
