# BPMN Agentic Opportunity Analysis: BPMN MIWG Test Suite

**Repository**: `agentic-readiness-analysis/example-reports/bao-demo/repos/bpmn-miwg-test-suite`
...
| C.5.0 | Interview customer, Create customer, Risk analysis | 370 | KYC/onboarding pipeline — Step Functions + Lambda |
...
>
> - Run the **Agentic Readiness Analysis (ARA)** on the target systems (contract management, invoice processing, document management) to obtain system-level data readiness signals.
...
- Data readiness analyses rely solely on BPMN model analysis (data associations, service task implementations, message flows, and task name inference)
...
**Recommended next step**: Run the Agentic Readiness Analysis on the following target systems:
...
*Report generated by BPMN Agentic Opportunity Analysis • 2026-04-28*
