...
- **AWS Professional Services**: Recommended for EKS cluster architecture design, database migration planning (DMS), and security posture analysis
...
|---|---------|-------------|-----------------|-----------|---------------|
| 1 | Alluxio--alluxio | Alluxio--alluxio/modernization-readiness-analysis/Alluxio--alluxio-mod-report.json | Unknown | application | 1.90 |
| 2 | FlowiseAI--Flowise | FlowiseAI--Flowise/modernization-readiness-analysis/FlowiseAI--Flowise-mod-report.json | 2025-05-07 | application | 2.14 |
| 3 | Graylog2--graylog2-server | Graylog2--graylog2-server/modernization-readiness-analysis/Graylog2--graylog2-server-mod-report.json | 2025-05-07 | application | 1.97 |
| 4 | Lidarr--Lidarr | Lidarr--Lidarr/modernization-readiness-analysis/Lidarr--Lidarr-mod-report.json | 2025-05-07 | application | 1.76 |
| 5 | Netflix--eureka | Netflix--eureka/modernization-readiness-analysis/Netflix--eureka-mod-report.json | 2026-05-07 | application | 1.50 |
| 6 | OpenAPITools--openapi-generator | OpenAPITools--openapi-generator/modernization-readiness-analysis/OpenAPITools--openapi-generator-mod-report.json | 2026-05-07 | application | 1.97 |
| 7 | Prowlarr--Prowlarr | Prowlarr--Prowlarr/modernization-readiness-analysis/Prowlarr--Prowlarr-mod-report.json | Unknown | application | 1.76 |
| 8 | Radarr--Radarr | Radarr--Radarr/modernization-readiness-analysis/Radarr--Radarr-mod-report.json | 2025-05-07 | application | 1.86 |
| 9 | Sonarr--Sonarr | Sonarr--Sonarr/modernization-readiness-analysis/Sonarr--Sonarr-mod-report.json | Unknown | application | 1.88 |
| 10 | ToolJet--ToolJet | ToolJet--ToolJet/modernization-readiness-analysis/ToolJet--ToolJet-mod-report.json | Unknown | application | 2.31 |
| 11 | apache--flink-connector-aws | apache--flink-connector-aws/modernization-readiness-analysis/apache--flink-connector-aws-mod-report.json | Unknown | monorepo | 2.68 |
| 12 | arrow | arrow-py--arrow/modernization-readiness-analysis/arrow-py--arrow-mod-report.json | Unknown | library | 2.96 |
| 13 | conductor-oss--conductor | conductor-oss--conductor/modernization-readiness-analysis/conductor-oss--conductor-mod-report.json | Unknown | application | 1.99 |
| 14 | coreui--coreui-free-angular-admin-template | coreui--coreui-free-angular-admin-template/modernization-readiness-analysis/coreui--coreui-free-angular-admin-template-mod-report.json | 2026-05-07 | application | 2.23 |
| 15 | druid | apache--druid/modernization-readiness-analysis/apache--druid-mod-report.json | Unknown | monorepo | 2.48 |
| 16 | dwyl--aws-sdk-mock | dwyl--aws-sdk-mock/modernization-readiness-analysis/dwyl--aws-sdk-mock-mod-report.json | 2025-05-07 | library | 2.99 |
| 17 | getlift--lift | getlift--lift/modernization-readiness-analysis/getlift--lift-mod-report.json | 2026-05-07 | library | 2.60 |
| 18 | getsentry--sentry-python | getsentry--sentry-python/modernization-readiness-analysis/getsentry--sentry-python-mod-report.json | 2025-05-07 | library | 2.95 |
| 19 | greenshot--greenshot | greenshot--greenshot/modernization-readiness-analysis/greenshot--greenshot-mod-report.json | Unknown | application | 1.54 |
| 20 | gulpjs--gulp | gulpjs--gulp/modernization-readiness-analysis/gulpjs--gulp-mod-report.json | Unknown | library | 2.38 |
| 21 | hapifhir--hapi-fhir | hapifhir--hapi-fhir/modernization-readiness-analysis/hapifhir--hapi-fhir-mod-report.json | Unknown | application | 2.35 |
| 22 | iterative--dvc | iterative--dvc/modernization-readiness-analysis/iterative--dvc-mod-report.json | 2026-05-07 | application | 2.06 |
| 23 | motdotla--node-lambda | motdotla--node-lambda/modernization-readiness-analysis/motdotla--node-lambda-mod-report.json | Unknown | application | 1.56 |
| 24 | ngx-admin | akveo--ngx-admin/modernization-readiness-analysis/akveo--ngx-admin-mod-report.json | 2025-05-07 | application | 1.50 |
| 25 | openzipkin--zipkin | openzipkin--zipkin/modernization-readiness-analysis/openzipkin--zipkin-mod-report.json | Unknown | application | 2.28 |
| 26 | realworld-apps--angular-realworld-example-app | realworld-apps--angular-realworld-example-app/modernization-readiness-analysis/realworld-apps--angular-realworld-example-app-mod-report.json | Unknown | application | 2.18 |
| 27 | scality--cloudserver | scality--cloudserver/modernization-readiness-analysis/scality--cloudserver-mod-report.json | Unknown | application | 2.22 |
| 28 | serverless--serverless | serverless--serverless/serverless--serverless-mod-report.json | Unknown | application | 2.77 |
| 29 | thingsboard--thingsboard | thingsboard--thingsboard/modernization-readiness-analysis/thingsboard--thingsboard-mod-report.json | Unknown | application | 1.90 |
| 30 | tqdm--tqdm | tqdm--tqdm/modernization-readiness-analysis/tqdm--tqdm-mod-report.json | 2026-05-08 | library | 2.60 |
| 31 | umami-software--umami | umami-software--umami/modernization-readiness-analysis/umami-software--umami-mod-report.json | 2026-05-08 | application | 1.71 |
| 32 | webpack--webpack | webpack--webpack/modernization-readiness-analysis/webpack--webpack-mod-report.json | Unknown | library | 2.88 |
| 33 | zappa--Zappa | zappa--Zappa/modernization-readiness-analysis/zappa--Zappa-mod-report.json | Unknown | application | 1.86 |
