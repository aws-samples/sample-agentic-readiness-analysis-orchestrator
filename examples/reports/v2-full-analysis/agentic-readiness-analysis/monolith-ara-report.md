...
- **Recommendation**: Conduct a data residency analysis with the legal/compliance team. Document which data fields have residency constraints. Ensure agent-accessible endpoints do not return residency-restricted data.
...
- **Recommendation**: Conduct data residency analysis with legal/compliance team.
