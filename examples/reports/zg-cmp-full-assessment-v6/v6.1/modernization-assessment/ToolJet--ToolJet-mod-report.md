...
| **Recommendation** | Use Bottlerocket for ECS container hosts or migrate fully to Fargate. Enable AWS Inspector for continuous vulnerability assessment. Make vulnerability scanning a blocking gate in CI (fail build on critical CVEs). Remove EC2 deployment path or document hardening procedures. |
