...
| **Repository** | druid |
| **Date** | 2026-05-07 |
| **TD Version** | modernization-assessment-v6 |
| **Repo Type** | monorepo |
...
| **Recommendation** | Enable ECR image scanning for the Docker image. Add OWASP dependency-check or Snyk as a CI pipeline step (not just suppression file maintenance). Consider AWS Inspector for runtime vulnerability assessment of deployed containers. |
