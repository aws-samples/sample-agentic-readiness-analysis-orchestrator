...
- **Gap**: The API exists and is documented via Swagger annotations. No gap for this question. However, per the dev-library-application override, the assessment acknowledges this is a secondary web wrapper around the primary CLI/library tools.
