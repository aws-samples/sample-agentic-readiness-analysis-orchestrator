...
| **Recommendation** | Switch to distroless or hardened base images. Pin all Docker image tags to specific digests. Add container image scanning (Amazon ECR image scanning or Snyk) to the CI/CD pipeline. Consider Amazon Inspector for runtime vulnerability analysis. |
