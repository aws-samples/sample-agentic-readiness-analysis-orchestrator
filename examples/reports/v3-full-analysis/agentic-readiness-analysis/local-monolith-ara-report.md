...
- **Remediation Timeline**: 30–60 days
- **Recommendation**: Conduct a data residency analysis. Document which customer data is subject to residency requirements. Configure the agent to use in-region LLM endpoints (e.g., Amazon Bedrock in the same region as RDS).
...
- **Recommendation**: Conduct data residency analysis. Use in-region LLM endpoints.
