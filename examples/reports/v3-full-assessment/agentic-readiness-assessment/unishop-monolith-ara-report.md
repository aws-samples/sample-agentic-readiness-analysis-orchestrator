...
- **Recommendation**: Conduct a data residency assessment for the PII stored in `unicorn_user`. Document which regulatory frameworks apply. Configure region-locked deployments and ensure agent LLM endpoints are co-located with the data.
...
- **Recommendation**: Conduct data residency assessment. Document regulatory requirements. Configure region-locked deployments.
