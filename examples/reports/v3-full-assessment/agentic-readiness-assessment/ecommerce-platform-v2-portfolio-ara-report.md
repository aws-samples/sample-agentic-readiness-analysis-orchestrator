...
- **Portfolio-Level Recommendation**: Conduct a portfolio-wide data residency assessment. Document which regulatory frameworks apply to customer PII. Establish a policy requiring all agent LLM endpoints to be co-located with data sources.
- **Estimated Effort**: Medium
