...
**Analysis Framework**: TD v2 — 43 questions, core/extended tiers, service archetypes
...
1. **Foundation Service — productcatalogservice (Fan-In=3, Pilot-Ready)**
   ...
   - Analysis: Safe foundation for agent integration. No transitive blocker risk.
...
2. **Orchestrator — checkoutservice (Fan-Out=6, Pilot-Ready)**
   ...
   - Analysis: Full checkout flow is agent-ready for supervised pilot. No transitive blockers in the dependency chain.
...
4. **Shared Infrastructure — platform-infra (Pilot-Ready)**
   ...
   - Analysis: Infrastructure layer is ready to support agent pilot deployment.
...
*Post-remediation analysis — Istio mTLS, OTel, proto versioning, data classification, HPAs, monitoring alerts, rate-limit EnvoyFilter applied*
