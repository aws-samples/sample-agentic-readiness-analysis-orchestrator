...
14. [Analysis Inventory](#analysis-inventory)
...
| Microsoft Modernization Program | MMP | C#/.NET workload migration | cartservice uses C# on .NET 10.0 | Request MMP analysis for cartservice migration path |
